...
public class ConvertMyCurrency {
   ...
   public static void main(String[] args) {
		...
		System.out.println("Please Choose the Currency You want to Convert ! ");
		
		System.out.println("1:RS \t2:$ \t3:Pound \n4:Euro \t5:Yen \t6:Ringgit ");
		code = sc.nextInt();
		...
		System.out.println("Keep on using Currency Converter");
	}
